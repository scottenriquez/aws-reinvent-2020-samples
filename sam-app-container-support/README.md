...
```bash
sam-app-container-support$ sam build
```
...
```bash
sam-app-container-support$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
sam-app-container-support$ sam local start-api
sam-app-container-support$ curl http://localhost:3000/
```
...
```bash
sam-app-container-support$ sam logs -n HelloWorldFunction --stack-name sam-app-container-support --tail
```
...
```bash
sam-app-container-support$ cd hello-world
...
```bash
aws cloudformation delete-stack --stack-name sam-app-container-support
```
